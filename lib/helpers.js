...
exports.log = exports.defaultLogger = (lvl, msg) => {
    ...
    const logLevelPrefix = `[${logLevelToString(lvl)}] `;
    const dateTimeString = new Date().toISOString();
    console.log(`[${dateTimeString}] ${logLevelPrefix}${msg}`);
};
...
exports.defaultClusterLogger = (lvl, msg) => {
    if (lvl <= logLevel) {
        ...
        const logLevelPrefix = `[${logLevelToString(lvl)}] `;
        const dateTimeString = new Date().toISOString();
        console.log(`[${dateTimeString}] ${prefix}${logLevelPrefix}${msg}`);
    }
};
...
function logLevelToString(lvl) {
    switch(lvl) {
        case consts.LOG_ERR:
            return "ERROR";
            break;
        case consts.LOG_WARN:
            return "WARN";
            break;
        case consts.LOG_INFO:
            return "INFO";
            break;
        case consts.LOG_DBG:
            return "DEBUG";
